...
-- Funções para confirmar e cancelar presença com lógica
-- automática de vagas e lista de espera.
-- ============================================================

-- 1. FUNÇÃO: Confirmar presença (com lógica de vagas automática)
...
DECLARE
  ...
  v_result jsonb;
BEGIN
  -- Buscar capacidade da turma via sessão
...
-- 2. FUNÇÃO: Cancelar presença (com promoção automática da lista de espera)
